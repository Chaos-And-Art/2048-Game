...
public class GameManager4x4 : MonoBehaviour {
	...
	void Start () {
        if(PlayerPrefs.GetInt("Grid") == 2 && PlayerPrefs.GetInt("Levels") == 1){
            if(PlayerPrefs.GetInt("Playing4x4", 0) == 1){
                CreateGrid();
                ExitLoad(0);
            }
            else{
            ...
            HighScoreClassic.SetText(PlayerPrefs.GetInt("HighScore 4x4", 0).ToString());
        }
    }
    ...
    public int theScore {
        ...
        set{
            ...
            if (score > PlayerPrefs.GetInt("HighScore 4x4", 0)){
                PlayerPrefs.SetInt("HighScore 4x4", score);
        ...
        if (Input.GetMouseButton(0) || (Input.touchCount == 1 && Input.GetTouch(0).phase == TouchPhase.Moved))
        {
            ...
            if (wait){
                ...
                if (move){
                    ...
                    PlayerPrefs.SetInt("Playing4x4", 1);
                    ExitSave();
                }
            }
        }
...
#region SaveAndLoad
    public void BackButton(){
        ...
        if(pressed == 0 || pressed == 1){   
            ...
            else if(PlayerPrefs.GetInt("Moved") == 0){
                LoadGame2(0);
    ...
    public void SaveGame1(){
        SavingSystem.SaveGame1(this);
    }
    public void LoadGame1(int index){
        SavedData1 data = SavingSystem.LoadGame1();
        string Tile = "Tiles";
    ...
    public void LoadGame2(int index){
        SavedData2 data = SavingSystem.LoadGame2();
        string Tile = "Tiles";
        if(PlayerPrefs.GetInt("Theme") == 0 || PlayerPrefs.GetInt("FirstTime") == 1){
            foreach(Transform tile in PlayGrid){
                Destroy(tile.gameObject);
...
#region TileMovement
    public void Move(MoveDirection move){
        if(PlayerPrefs.GetInt("Moved") == 0){
            SaveGame1();
            PlayerPrefs.SetInt("Moved", 1);
        }
        else if(PlayerPrefs.GetInt("Moved") == 1){
            SaveGame2();
            PlayerPrefs.SetInt("Moved", 0);
        }
        pressed = 0;
